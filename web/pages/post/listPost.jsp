...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang" width="100%">
    <tr>
        ...
        <td width="57%" align="right">
            <%--添加职务 --%>
            <a href="${pageContext.request.contextPath}findAllDepartment1.action">
    ...
    <s:iterator value="#pageBean.data" var="post">
        <tr class="tabtd1">
            ...
            <td width="7%" align="center">
                <a href="${pageContext.request.contextPath}findAllDepartment1.action?postId=${post.postId}&postName=${post.postName}&depName=${post.department.depName}&depId=${post.department.depId}"><img
