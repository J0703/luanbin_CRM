...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010302','0103','课程类别','${pageContext.request.contextPath}/findAll.action','','right');
		d.add('0104','01','就业部');
		d.add('010401','0104','就业情况','${pageContext.request.contextPath}/pages/graduate/listGraduate.jsp','','right');
		d.add('0105','01','人力资源部');
		d.add('010501','0105','部门管理','${pageContext.request.contextPath}/findAllDepartmentP.action','','right');
